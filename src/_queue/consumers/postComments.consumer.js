...
const PostCommentConsumer = new Connnection(KEYS.AMQP_URI, KEYS.UPDATE_USER_POST_COMMENT_DETAILS,
  async (msg) => {
    ...
    if (msg !== null) {
      ...
      try {
    //    update records here
    const updatedrecords = await new PostCommentsService().updateMany({ commenter_id:id}, bodyData);
